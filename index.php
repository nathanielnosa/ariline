		...
		<div class="col-lg-12">
			...
			<div class="col-lg-4" style="background-image: url('img/px2.png'); padding:3em;">
				...
				if (isset($_POST['loginbtn'])) {
					login($airline, $_POST['uname'], $_POST['psw']);
				}
				?>
				<form method="POST" action="#">
			<div class="form-group">
				<input type="text" name="uname" autofocus="" class="form-control" placeholder="Enter username" required="" style="background-color: transparent; color:#ffffff;" />
			</div>
			<div>
				<input type="password" name="psw" class="form-control" placeholder="Enter password" required="" style="background-color: transparent; color:#ffffff;">
			</div><br>
			<div class="form-group">
				<button type="submit" class="btn btn-primary" name="loginbtn" style="width: 100%; padding: 1em;"><span class="glyphicon glyphicon-log-in"></span> Login</button>
			</div>
			</form>
			<center>
				<a href="register.php" class="btn btn-default" style="background-color: transparent;  color: white; float: left"><span class="glyphicon glyphicon-user"></span> Register</a>
